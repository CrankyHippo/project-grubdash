...
function orderHasDeliverTo(req, _res, next) {
...
function orderHasMobileNumber(req, _res, next) {
...
function orderHasStatus(req, _res, next) {
...
function orderHasValidStatus(req, _res, next) {
  const { data: { status } = {} } = req.body;
  if (
    status === "pending" ||
    status === "preparing" ||
...
function orderHasDishes(req, _res, next) {
...
function dishesArrayIsArray(req, _res, next) {
  const { data: { dishes } = {} } = req.body;
...
function orderHasQuantity(req, _res, next) {
  const { data: { dishes } = {} } = req.body;
...
function orderQuantityIsInteger(req, _res, next) {
  const { data: { dishes } = {} } = req.body;
...
function checkStatusForPending(_req, res, next) {
...
function orderIdMatches(req, _res, next) {
  const { orderId } = req.params;

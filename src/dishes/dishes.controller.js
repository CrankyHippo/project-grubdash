...
function dishHasName(req, _res, next) {
...
function dishHasDescription(req, _res, next) {
...
function dishHasPrice(req, _res, next) {
...
function priceIsNum(req, _res, next) {
  const { data: { price } = {} } = req.body;
...
function dishHasImgUrl(req, _res, next) {
...
function dishIdMatches(req, _res, next) {
  const { dishId } = req.params;
